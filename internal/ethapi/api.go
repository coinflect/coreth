...
import (
	...
	"github.com/coinflect/coreth/accounts/abi"
	"github.com/coinflect/coreth/accounts/keystore"
	"github.com/coinflect/coreth/accounts/scwallet"
	...
	"github.com/coinflect/coreth/eth/tracers/logger"
	"github.com/coinflect/coreth/params"
	"github.com/coinflect/coreth/rpc"
	"github.com/coinflect/coreth/vmerrs"
...
// In coreth, coinflectchain prevents API calls unless bootstrapping is complete,
...
func AccessList(ctx context.Context, b Backend, blockNrOrHash rpc.BlockNumberOrHash, args TransactionArgs) (acl types.AccessList, gasUsed uint64, vmErr error, err error) {
	...
	precompiles := vm.ActivePrecompiles(b.ChainConfig().CoinflectRules(header.Number, new(big.Int).SetUint64(header.Time)))
