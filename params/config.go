...
import (
	...
	"github.com/coinflect/coreth/precompile"
...
// Coinflect ChainIDs
var (
	// CoinflectMainnetChainID ...
	CoinflectMainnetChainID = big.NewInt(43114)
	// CoinflectAddismyaChainID ...
	CoinflectAddismyaChainID = big.NewInt(43113)
	// CoinflectLocalChainID ...
	CoinflectLocalChainID = big.NewInt(43112)

	errNonGenesisForkByHeight = errors.New("coreth only supports forking by height at the genesis block")
)

var (
	// CoinflectMainnetChainConfig is the configuration for Coinflect Main Network
	CoinflectMainnetChainConfig = &ChainConfig{
		ChainID:                         CoinflectMainnetChainID,
	...
	// CoinflectAddismyaChainConfig is the configuration for the Addismya Test Network
	CoinflectAddismyaChainConfig = &ChainConfig{
		ChainID:                         CoinflectAddismyaChainID,
		HomesteadBlock:                  big.NewInt(0),
		DAOForkBlock:                    big.NewInt(0),
		DAOForkSupport:                  true,
		EIP150Block:                     big.NewInt(0),
	...
	// CoinflectLocalChainConfig is the configuration for the Coinflect Local Network
	CoinflectLocalChainConfig = &ChainConfig{
		ChainID:                         CoinflectLocalChainID,
		HomesteadBlock:                  big.NewInt(0),
		DAOForkBlock:                    big.NewInt(0),
		DAOForkSupport:                  true,
		EIP150Block:                     big.NewInt(0),
	...
	TestChainConfig             = &ChainConfig{CoinflectContext{common.Hash{1}}, big.NewInt(1), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0)}
	TestLaunchConfig            = &ChainConfig{CoinflectContext{common.Hash{1}}, big.NewInt(1), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, nil, nil, nil, nil, nil, nil}
	TestApricotPhase1Config     = &ChainConfig{CoinflectContext{common.Hash{1}}, big.NewInt(1), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, nil, nil, nil, nil, nil}
	TestApricotPhase2Config     = &ChainConfig{CoinflectContext{common.Hash{1}}, big.NewInt(1), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, nil, nil, nil, nil}
	TestApricotPhase3Config     = &ChainConfig{CoinflectContext{common.Hash{1}}, big.NewInt(1), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, nil, nil, nil}
	TestApricotPhase4Config     = &ChainConfig{CoinflectContext{common.Hash{1}}, big.NewInt(1), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, nil, nil}
	TestApricotPhase5Config     = &ChainConfig{CoinflectContext{common.Hash{1}}, big.NewInt(1), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, nil}
	TestApricotPhasePre6Config  = &ChainConfig{CoinflectContext{common.Hash{1}}, big.NewInt(1), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil}
	TestApricotPhase6Config     = &ChainConfig{CoinflectContext{common.Hash{1}}, big.NewInt(1), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil}
	TestApricotPhasePost6Config = &ChainConfig{CoinflectContext{common.Hash{1}}, big.NewInt(1), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil}
	TestBanffChainConfig        = &ChainConfig{CoinflectContext{common.Hash{1}}, big.NewInt(1), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil}
	TestCortinaChainConfig      = &ChainConfig{CoinflectContext{common.Hash{1}}, big.NewInt(1), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0)}
	TestRules                   = TestChainConfig.CoinflectRules(new(big.Int), new(big.Int))
)
...
type ChainConfig struct {
	CoinflectContext `json:"-"` // Coinflect specific context set during VM initialization. Not serialized.
...
// CoinflectContext provides Coinflect specific context directly into the EVM.
type CoinflectContext struct {
...
func (c *ChainConfig) String() string {
	...
	banner += fmt.Sprintf(" - Apricot Phase 1 Timestamp:        %-8v (https://github.com/coinflect/coinflectchain/releases/tag/v1.3.0)\n", c.ApricotPhase1BlockTimestamp)
	banner += fmt.Sprintf(" - Apricot Phase 2 Timestamp:        %-8v (https://github.com/coinflect/coinflectchain/releases/tag/v1.4.0)\n", c.ApricotPhase2BlockTimestamp)
	banner += fmt.Sprintf(" - Apricot Phase 3 Timestamp:        %-8v (https://github.com/coinflect/coinflectchain/releases/tag/v1.5.0)\n", c.ApricotPhase3BlockTimestamp)
	banner += fmt.Sprintf(" - Apricot Phase 4 Timestamp:        %-8v (https://github.com/coinflect/coinflectchain/releases/tag/v1.6.0)\n", c.ApricotPhase4BlockTimestamp)
	banner += fmt.Sprintf(" - Apricot Phase 5 Timestamp:        %-8v (https://github.com/coinflect/coinflectchain/releases/tag/v1.7.0)\n", c.ApricotPhase5BlockTimestamp)
	banner += fmt.Sprintf(" - Apricot Phase P6 Timestamp        %-8v (https://github.com/coinflect/coinflectchain/releases/tag/v1.8.0)\n", c.ApricotPhasePre6BlockTimestamp)
	banner += fmt.Sprintf(" - Apricot Phase 6 Timestamp:        %-8v (https://github.com/coinflect/coinflectchain/releases/tag/v1.8.0)\n", c.ApricotPhase6BlockTimestamp)
	banner += fmt.Sprintf(" - Apricot Phase Post-6 Timestamp:   %-8v (https://github.com/coinflect/coinflectchain/releases/tag/v1.8.0\n", c.ApricotPhasePost6BlockTimestamp)
	banner += fmt.Sprintf(" - Banff Timestamp:                  %-8v (https://github.com/coinflect/coinflectchain/releases/tag/v1.9.0)\n", c.BanffBlockTimestamp)
	banner += fmt.Sprintf(" - Cortina Timestamp:                %-8v (https://github.com/coinflect/coinflectchain/releases/tag/v1.10.0)\n", c.CortinaBlockTimestamp)
	banner += "\n"
	return banner
}
...
func (c *ChainConfig) CheckConfigForkOrder() error {
	...
	// hard forks. In Coinflect, hard forks must take place via block timestamps instead
	...
	// TODO(aaronbuchwald) check that coinflect block timestamps are at least possible with the other rule set changes
...
// CoinflectRules returns the Coinflect modified rules to support Coinflect
// network upgrades
func (c *ChainConfig) CoinflectRules(blockNum, blockTimestamp *big.Int) Rules {
