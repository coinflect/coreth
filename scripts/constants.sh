...
# Set binary location
binary_path=${CORETH_BINARY_PATH:-"$GOPATH/src/github.com/coinflect/coinflectchain/build/plugins/evm"}

# Avalabs docker hub
dockerhub_repo="avaplatform/coinflectchain"
...
build_image_id=${BUILD_IMAGE_ID:-"$coinflect_version-$coreth_commit_id"}
