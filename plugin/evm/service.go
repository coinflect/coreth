...
// CfltAPI offers Coinflect network related API methods
type CfltAPI struct{ vm *VM }

// parseAssetID parses an assetID string into an ID
func (service *CfltAPI) parseAssetID(assetID string) (ids.ID, error) {
	if assetID == "" {
		return ids.ID{}, fmt.Errorf("assetID is required")
	} else if assetID == "CFLT" {
		return service.vm.ctx.CFLTAssetID, nil
	} else {
...
func (service *CfltAPI) Version(r *http.Request, args *struct{}, reply *VersionReply) error {
...
func (service *CfltAPI) ExportKey(r *http.Request, args *ExportKeyArgs, reply *ExportKeyReply) error {
...
func (service *CfltAPI) ImportKey(r *http.Request, args *ImportKeyArgs, reply *api.JSONAddress) error {
...
// ImportCFLT is a deprecated name for Import.
func (service *CfltAPI) ImportCFLT(_ *http.Request, args *ImportArgs, response *api.JSONTxID) error {
	return service.Import(nil, args, response)
}

// Import issues a transaction to import CFLT from the X-chain. The CFLT
// must have already been exported from the X-Chain.
func (service *CfltAPI) Import(_ *http.Request, args *ImportArgs, response *api.JSONTxID) error {
	log.Info("EVM: ImportCFLT called")
...
// ExportCFLTArgs are the arguments to ExportCFLT
type ExportCFLTArgs struct {
	api.UserPass
	...
	// ID of the address that will receive the CFLT. This address includes the
	// chainID, which is used to determine what the destination chain is.
	To string `json:"to"`
}

// ExportCFLT exports CFLT from the C-Chain to the X-Chain
// It must be imported on the X-Chain to complete the transfer
func (service *CfltAPI) ExportCFLT(_ *http.Request, args *ExportCFLTArgs, response *api.JSONTxID) error {
	return service.Export(nil, &ExportArgs{
		ExportCFLTArgs: *args,
		AssetID:        service.vm.ctx.CFLTAssetID.String(),
	}, response)
}
...
// It must be imported on the X-Chain to complete the transfer
func (service *CfltAPI) Export(_ *http.Request, args *ExportArgs, response *api.JSONTxID) error {
...
func (service *CfltAPI) GetUTXOs(r *http.Request, args *api.GetUTXOsArgs, reply *api.GetUTXOsReply) error {
...
// IssueTx ...
func (service *CfltAPI) IssueTx(r *http.Request, args *api.FormattedTx, response *api.JSONTxID) error {
...
func (service *CfltAPI) GetAtomicTxStatus(r *http.Request, args *api.JSONTxID, reply *GetAtomicTxStatusReply) error {
...
func (service *CfltAPI) GetAtomicTx(r *http.Request, args *api.GetTxArgs, reply *FormattedTx) error {
